...
public interface BeanReaderInstructions<T> {
    ...
    * is used. The default value for this setting is true. This call is a facade for
     * {@link LineReaderInstructions#setUseHeader(boolean)}.
    ...
    * setting is 0. This call is a facade for {@link LineReaderInstructions#setStartRow(int)}.
    ...
    * {@link LineReaderInstructions#setEscape(char)}.
    ...
    * {@link LineReaderInstructions#setQuote(char)}.
    ...
    * setting is a semi-colon (;). This call is a facade for {@link LineReaderInstructions#setSeparator(char)}.
    ...
    * {@link LineReaderInstructions#setEndOfLine(char[])}.
