...
*       {@link org.csveed.annotations.CsvFile#mappingStrategy()} is set to
*       {@link org.csveed.bean.ColumnIndexMapper}. Properties are read in declaration order from
*       their classes which translates directly to their column index.</li>
*     <li>Column Name Mapping; used if  {@link org.csveed.annotations.CsvFile#mappingStrategy()}
*       is set to {@link org.csveed.bean.ColumnNameMapper}. By default the name of the property
