 ...
 * ways to initialize a {@link org.csveed.api.CsvClientImpl}:
 * </p>
 * <ul>
 * <li>Just use a Reader/Writer. In this case you can only use the row functionality of CSVeed, not the bean
 * functionality</li>
 * <li>Pass a Reader or Writer and point it to class. The {@link org.csveed.annotations} in the class are read, as is
 * the order of the properties within the class.</li>
...
public interface CsvClient<T> {
     ...
     *
     * @param startIndex
     *            the index where the dynamic columns start
     *
     * @return convenience for chaining
     */
     ...
     *
     * @param columnIndex
     *            index of the column for which the property mapping must be applied
     * @param propertyName
     ...
     *
     * @param columnName
     *            name of the column for which the property mapping must be applied
     * @param propertyName
